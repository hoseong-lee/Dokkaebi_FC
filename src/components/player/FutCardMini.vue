...
// 갤러리(도감) 그리드용 미니 FUT 카드 — 가벼움 (홀로/틸트 없음, 클릭 시 전체 카드 모달)
...
<template>
  <div class="relative aspect-[5/7] select-none drop-shadow-md cursor-pointer hover:scale-[1.03] transition-transform">
