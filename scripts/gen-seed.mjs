...
const MATCHES = [
  ...
  { id: 'm08', date: '2025-03-23T16:00', opp: 'EX FC', loc: '초안산',
  ...
  { id: 'm13', date: '2025-05-17T16:00', opp: '도깨비 자체전', loc: '초안산', type: 'self',
    att: att('김진오 김영우 박한주 윤범관 김청수 박준희 김주성 강성섭 한지민 박재익 신승민 김성민 정병진 임상범 권용재 정도현 김광현 김세욱 손인석 마진섭 유희창 이호성 김우재 홍성현 김지웅 용재동생 용재지인 문종일'),
    quarters: [q(0, [['청수']]), q(0), q(0), q(0, [['종일']])] },
  ...
  { id: 'm18', date: '2025-09-20T17:00', opp: '도깨비 자체전', loc: '창골운동장', type: 'self',
    att: att('마진섭 임상범 윤범관 권순찬 이구상 박한주 유희창 김진오 정순인 송승우 김청수 한지민 문종일 신승민 김지웅 김주성 김광현 최상현 김동민 진윤현 우성균 김세욱'),
    quarters: [q(0, [['김광현'], ['김광현'], ['이구상'], ['동민'], ['동민']]), q(0, [['청수']]), q(0), q(0, [['동민'], ['동민']])] },
  ...
  { id: 'm31', date: '2026-04-18T18:00', opp: '국대FC', loc: '초안산',
